  ...
  return (
    <Tab.Navigator initialRouteName='Wish'>
      <Tab.Screen name="Wish" options={{
        headerShown: false, tabBarLabel: "Wish", tabBarIcon: ({ color }) => (
          <Icon name="text-long" color={color} size={30} />
        )
      }} >
        {(props) => <Wishes {...props} lang={'Hindi'} festival={festival} />}
      </Tab.Screen>
      <Tab.Screen name="InspiringImages" options={{
        headerShown: false, tabBarLabel: "Image", tabBarIcon: ({ color }) => (
          <Icon name="image-outline" color={color} size={30} />
        )
      }}>
        {(props) => <InspiringImages {...props} festival={festival} />}
      </Tab.Screen>

      <Tab.Screen name="Stickers" options={{
        headerShown: false, tabBarLabel: "Stickers", tabBarIcon: ({ color }) => (
          <Icon name="sticker-emoji" color={color} size={30} />
        )
      }}>
        {(props) => <StickerScreen {...props} festival={festival} />}
      </Tab.Screen>
    </Tab.Navigator>
  );
}